...
//	int count = 0, len = 0;
	while (1)
	{
		...
		{
			if (DeviceControlMessage.DeviceNumber == 0x01)         			//Villa Level 1 or Booth
			{
			...
			} else if (DeviceControlMessage.DeviceNumber == 0x02)//Villa Level 2 or single-apartment
			{
				switch (DeviceControlMessage.ControlMode)
				{
					case 0x00:
			...
			} else if (DeviceControlMessage.DeviceNumber == 0x03)					//Villa Level 3
			{
				switch (DeviceControlMessage.ControlMode)
				{
					case 0x00:
...
//		else if (DeviceControlMessage.DeviceNumber == 0x04)							//Booth
//			{
//				switch (DeviceControlMessage.ControlMode)
//				{
//					case 0x00:
...
//						break;			//Music mode, serial port 1
//				}
//			} else if (DeviceControlMessage.DeviceNumber == 0x05)				//single-apartment
//			{
//				switch (DeviceControlMessage.ControlMode)
//				{
//					case 0x00:
